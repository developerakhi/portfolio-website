            ...
            <form action="{{route('admin.portfolios.store')}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="form-group col-md-3 mt-3">
                        <h3>Big Image</h3>
                        <img style="height: 30vh" src="{{asset('assets/img/big_image.jpg')}}" class="img-thumbnail" alt="img">
                        <input class="mt-3" type="file" id="big_img" name="big_img">
                    </div>
                    <div class="form-group col-md-3 mt-3">
                        <h3>Small Image</h3>
                        <img style="height: 20vh" src="{{asset('assets/img/small_image.jpg')}}" class="img-thumbnail" alt="img">
